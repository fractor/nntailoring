...
function oneStep() {
    ...
    var trainClassesCount = getNumberOfEachClass(network, trainData);
    console.log('train classesCount: ', trainClassesCount);
    var testClassesCount = getNumberOfEachClass(network, testData);
    console.log('test classesCount: ', testClassesCount);
    var trainClassesAccuracy = getAccuracyForEachClass(network, trainData);
    var testClassesAccuracy = getAccuracyForEachClass(network, testData);
